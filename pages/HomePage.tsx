...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-full p-4 md:p-8 relative">
        <div 
            className="absolute inset-0 z-0 bg-cover bg-center opacity-5 dark:opacity-10 animate-subtle-pan"
        ...
        ></div>
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-[var(--background-color)]/50 via-[var(--background-color)] to-[var(--background-color)]"></div>
